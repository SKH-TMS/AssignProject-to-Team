...
export async function POST(req: NextRequest) {
  try {
    ...
    // Ensure the project is not already assigned to a team
    if (project.assignedLog && project.assignedLog !== "no-one") {
      return NextResponse.json(
    ...
    // Update the project's assignedLog field with the new AssignProjectId
    project.assignedLog = assignedLog.AssignProjectId;
    project.assignedTeam = { teamId: team.teamId, teamName: team.teamName };
